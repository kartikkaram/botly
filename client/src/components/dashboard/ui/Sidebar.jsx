...
import { cn } from "@/lib/utils"; // if using clsx or your own classnames utility
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-lg font-bold mb-6">{isHovered ? <span className="text-xl flex justify-center"><BsRobot/> Botly</span> : <BsRobot/>}</h1>
